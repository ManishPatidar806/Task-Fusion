...
<body>
  ...
  <footer id="footer">
    <div id="slideContainer">
      <div id="slide1">
        <div id="desc">
          <div id="title">TF (Task Fusion)</div>
          <div id="details">
            Task Fusion is a platform from which employees and managers can use for collaboration
            and communication.
          </div>
        </div>
        <div id="socialBtnContainer">
        <a href="https://www.facebook.com/profile.php?id=100028745823950&mibextid=ZbWKwL"><i class="fa-brands fa-square-facebook"></i></a>
